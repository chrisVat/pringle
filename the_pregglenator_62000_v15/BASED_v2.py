"""
modulo machine + worker SA + superstep-density edge weights
...
def main():
    ap = argparse.ArgumentParser(
        description="BASED_v2_fast — pandas loading + pickle cache"
    )
    ...
    ap.add_argument("--c_net",             type=float, default=0.25,
    ...
    ap.add_argument("--c_node",            type=float, default=4.0,
